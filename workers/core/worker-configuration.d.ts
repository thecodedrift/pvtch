/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a8d0b6a80261cdcd9aa4d9b23dd1867f)
// Runtime types generated with workerd@1.20251217.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/handler");
		durableNamespaces: "PvtchBackend";
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEVELOPMENT" | "DISABLE_CACHE" | "TWITCH_CLIENT_ID" | "TWITCH_SECRET" | "PVTCH_APP_URL" | "TWITCH_REDIRECT_URI">> {}
}
