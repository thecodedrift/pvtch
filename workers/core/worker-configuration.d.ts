/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ae249acfc7ccebb539c3cb1c1ba14ba)
// Runtime types generated with workerd@1.20260114.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/handler");
		durableNamespaces: "PvtchBackend" | "User";
	}
	interface Env {
		PVTCH_KV: KVNamespace;
		PVTCH_ACCOUNTS: KVNamespace;
		PVTCH_TRANSLATIONS: KVNamespace;
		ALLOWED_USERS: "";
		DEVELOPMENT: string;
		DISABLE_CACHE: string;
		TWITCH_CLIENT_ID: string;
		TWITCH_SECRET: string;
		PVTCH_APP_URL: string;
		TWITCH_REDIRECT_URI: string;
		PVTCH_BACKEND: DurableObjectNamespace<import("./cloudflare/handler").PvtchBackend>;
		PVTCH_USER: DurableObjectNamespace<import("./cloudflare/handler").User>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_USERS" | "DEVELOPMENT" | "DISABLE_CACHE" | "TWITCH_CLIENT_ID" | "TWITCH_SECRET" | "PVTCH_APP_URL" | "TWITCH_REDIRECT_URI">> {}
}
